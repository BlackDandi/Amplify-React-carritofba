...
import Imagen from "../Imagenes/soul1.png"
        ...
        >
          ...
          >
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="La mejor pagina para comprar online"
              {...getOverrideProps(
                overrides,
                "Ut enim ad minim veniam quis nostrud"
              )}
            ...
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="Descruble la variedad de NFTS,Videojuegos y licencias de software de la mejor calidad y el menor precio."
              {...getOverrideProps(
                overrides,
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco."
              )}
